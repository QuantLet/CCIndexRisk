...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/return/p_type.png", gg, width = 5000, height = 4500, 
...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/return/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/return/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/return/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/return/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/return/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/return/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/return/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/return/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
d_L2 <- matrix(rep(NA, (ncol(data_NA)-1)^2), nrow = (ncol(data_NA)-1))
for (i in (2:ncol(data_NA))){
  for (j in (2:ncol(data_NA))){
    d_L2[(i-1),(j-1)] <- l2norm(data_NA[,i], data_NA[,j])
  }
}
colnames(d_L2) <- colnames(data_NA)[-1]
rownames(d_L2) <- colnames(data_NA)[-1]
...
MDS_plot <- data.frame(x = MDS_fit$points[,1],
                       y = MDS_fit$points[,2])
rownames(MDS_plot) <- colnames(data_NA)[-1]
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/return/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/return/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/return/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
#################################### ks-test ###################################
################################################################################
d_ks_s <- matrix(rep(NA, (ncol(data)-1)^2), nrow = (ncol(data)-1))
for (i in (2:ncol(data))){
  for (j in (2:ncol(data))){
    d_ks_s[(i-1),(j-1)] <- ks.test(data[,i], data[,j], exact=FALSE)$statistic*100
  }
}
colnames(d_ks_s) <- colnames(data)[-1]
rownames(d_ks_s) <- colnames(data)[-1]

################################################################################
### Calculate MDS
set.seed(12345)
MDS_fit <- cmdscale(d_ks_s, eig = TRUE, k = 2)
MDS_plot <- data.frame(x = MDS_fit$points[,1],
                       y = MDS_fit$points[,2])
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/ks_test/return/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/ks_test/return/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/ks_test/return/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
