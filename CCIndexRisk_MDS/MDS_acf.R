...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/acf/p_type.png", gg, width = 5000, height = 4500, 
...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/acf/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg
ggsave("CCIndexRisk_MDS/Output/Euclide_distance/acf/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/acf/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/acf/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Pearson_correlation/acf/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/acf/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/acf/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/Cosine_similarity/acf/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_type, order = as.numeric(factor(p_type))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 19, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/acf/p_type.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_reb, order = as.numeric(factor(p_reb))))+ 
  ...
  scale_shape_manual(values=c(17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/acf/p_reb.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
...
gg <- ggplot2::ggplot(MDS_plot, aes(x=x, y=y, col=p_max, order = as.numeric(factor(p_max))))+ 
  ...
  scale_shape_manual(values=c(17, 17, 17, 19, 15, 15))
gg
ggsave("CCIndexRisk_MDS/Output/L2/acf/p_max.png", gg, width = 5000, height = 4500, 
       dpi = 500, units = "px", limitsize = F)
